...
const pieChart = new Chart(ctx2, {
	...
	data: {
		...
		labels: [
			'Red: Barren land',
			'Yellow: Shrubs',
			'Light Green: Healthy grassland',
			'Green Green: Vigorous crops ',
		...
		datasets: [
			{
				...
				data: [],
				borderWidth: 0,
				backgroundColor: ['Red', 'Yellow', '#b5e7a0', '#86af49', 'Green'], //update colors for category
			},
		],
	},
	options: {
...
// Position the download button at the top of the map
const exportBtn = document.getElementById('export-png');
exportBtn.style.position = 'absolute';
exportBtn.style.top = '130px';
exportBtn.style.left = '57%';
exportBtn.style.transform = 'translateX(-50%)';
// End of Map Button Position
